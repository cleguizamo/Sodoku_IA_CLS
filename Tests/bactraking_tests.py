...
from src.bactracking import solve_backtracking
...
if solve_backtracking(board_easy):
...
start_time = time.time()
if solve_backtracking(board_medium):
    print("Solución encontrada con Backtracking:")
    print_board(board_medium)
else:
    print("No se encontró solución con Backtracking.")
...
start_time = time.time()
if solve_backtracking(board_hard):
    print("Solución encontrada con Backtracking:")
    print_board(board_hard)
else:
    print("No se encontró solución con Backtracking.")
...
start_time = time.time()
if solve_backtracking(board_no_solution):
    print("Solución encontrada con Backtracking:")
    print_board(board_no_solution)
else:
    print("No se encontró solución con Backtracking.")
